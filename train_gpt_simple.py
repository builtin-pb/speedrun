...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--gate-feature-dim", type=int, default=12, help="Width of the normalized residual slice used to predict attention/MLP gates.")
    parser.add_argument("--gate-delta-scale", type=float, default=0.75, help="Maximum learned deviation of residual gates away from the baseline scale of 1.")
    ...
    parser.add_argument("--gate-bias-lr", type=float, default=0.004, help="Optional override for residual gate bias learning rate.")
    parser.add_argument("--gate-bias-beta2", type=float, default=0.99, help="Optional override for residual gate bias AdamW beta2.")
    parser.add_argument("--gate-bias-weight-decay", type=float, default=0.0, help="Optional override for residual gate bias weight decay.")
