...
class TrainArgsTests(unittest.TestCase):
    ...
    def test_gate_tuning_args_have_defaults_and_can_be_overridden(self) -> None:
        ...
        self.assertEqual(default_args.gate_feature_dim, 12)
        self.assertEqual(default_args.gate_delta_scale, 0.75)
        ...
        self.assertEqual(default_args.gate_lr, 0.004)
        ...
        self.assertEqual(default_args.gate_bias_lr, 0.004)
        self.assertEqual(default_args.gate_bias_beta2, 0.99)
        self.assertEqual(default_args.gate_bias_weight_decay, 0.0)
